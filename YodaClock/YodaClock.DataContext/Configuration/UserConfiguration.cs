...
namespace YodaClock.DataContext
{
    ...
    public class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(x => x.Token).HasColumnName(@"Token").HasColumnType("nvarchar(100)").IsRequired().HasMaxLength(100);

            // Foreign keys
            builder.HasOne(a => a.Plan).WithMany(b => b.Users).HasForeignKey(c => c.PlanId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_User_Plan");
        }
    }
